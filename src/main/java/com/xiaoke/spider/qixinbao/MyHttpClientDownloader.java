...
public class MyHttpClientDownloader extends AbstractDownloader {
    ...
    public MyHttpClientDownloader(Site site) {
        this.site = site;
    }

    public long getLastStartSpiderTime() {
        return startDownloadTime;
    }

    public long getLastEndSpiderTime() {
    ...
    public Page download(Request request, Task task) {
        ...
        try {
            ...
            if (statusAccept(acceptStatCode, statusCode)) {
                ...
                logger.error("code error " + statusCode + "\t" + request.getUrl());
                if (statusCode == 201) {
                    try {
                        Thread.sleep(5000);
            ...
            logger.info("downloading page spend {} mills", (endDownloadTime - startDownloadTime));
            request.putExtra(Request.STATUS_CODE, statusCode);
            try {
